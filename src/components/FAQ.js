...
const faqs = [
  {
    ...
    answer: "We welcome children ages 2-6 years old. Our mixed-age approach allows younger children to learn from older peers while older children develop leadership skills."
  },
  {
    question: "What are your program hours?",
    answer: "We offer full-day programs from 8:00 AM to 3:00 PM, Monday through Friday. Extended care options are available for families who need earlier drop-off or later pick-up times."
  },
  {
    question: "Do children need previous experience with animals?",
    answer: "No previous experience is necessary! We teach children how to safely and respectfully interact with our animals. Our experienced staff guides each child at their own pace."
  },
  {
    question: "How can I schedule a tour?",
    answer: "You can schedule a tour by contacting us through our website's contact form, calling us directly, or sending us an email. We offer tours on weekday mornings so you can see our program in action."
  }
]
    ...
    <div className="mb-6">
      ...
      >
        <div className="flex-1 md:pr-10">
          ...
          >
            <p className="max-w-md text-coolGray-400 font-medium">
              {answer}
            </p>
          </div>
        </div>
            ...
            <div className="w-full md:w-1/2 px-4 mb-20 md:mb-0">
              <div className="max-w-md">
                ...
                <p className="text-lg md:text-xl text-coolGray-400 font-medium">
                  Have questions about enrollment, our programs, or what a day looks like at Wild Sprouts? We're here to help!
                </p>
              </div>
            </div>
