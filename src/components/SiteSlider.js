...
const animals = [
  {
    title: "Daisy the Goat",
    description: "Our gentle Nigerian Dwarf goat loves morning cuddles and treats from the children.",
    imageAlt: "Daisy the Goat",
    image: "/goat.jpg",
  },
  {
    title: "Clucky & Friends",
    description: "Our flock of chickens teach children about responsibility and the cycle of farm life.",
    imageAlt: "Chickens at the homestead",
    image: "/chicken.jpg",
  },
  {
    title: "Thumper & Cottontail",
    description: "Our friendly rabbits are perfect for gentle interactions and learning about animal care.",
    imageAlt: "Rabbits at the homestead",
    image: "/rabbit.jpg",
  },
]
